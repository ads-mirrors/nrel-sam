...
folder_location = "C:\\Users\\tbrown2\\OneDrive - NREL\\sCO2-CSP 10302.41.01.40\\Notes\\G3P3\\runs\\baseline_orig\\"
Nproc = 20
eta_cutoff = 0.2
...
def get_sco2_G3P3():
    ...
    des_par["dT_PHX_cold_approach"] = des_par["dT_PHX_hot_approach"]     # [C/K] Temperature difference between cold HTF and hot sco2
...
def run_G3P3_tsf_sweep(n_par, run_folder = ''):
    ...
    solve_collection = design_pt.run_opt_parallel_solve_dict(dict_list, default_par, Nproc)

    file_name = "TSF_G3P3_collection"
    combined_name = folder_location + run_folder + file_name  + '_' + str(n_par) + '_' + design_pt.get_time_string() + ".csv"
