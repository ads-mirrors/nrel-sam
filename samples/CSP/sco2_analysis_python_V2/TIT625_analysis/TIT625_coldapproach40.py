...
def run_case():
    ...
    # Modify cold approach temperature
    default_par["dT_PHX_cold_approach"] = 40     # [C/K] Temperature difference between cold HTF and hot sco2
    ...
    n_par = 10
    run_name = "TIT625_coldapproach40"
    run_g3p3 = True
