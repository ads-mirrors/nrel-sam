...
def run_case():
    ...
    # Modify baseline for TIT 625
    T_turbine_in = 625  # [C]
    default_par["dT_PHX_hot_approach"] = default_par["T_htf_hot_des"] - T_turbine_in

    # Modify eta
    default_par["eta_isen_t"] = 0.85   # [-] Turbine isentropic efficiency
    default_par["eta_isen_t2"] = 0.85  # [-] Secondary turbine isentropic efficiency
    default_par["eta_isen_mc"] = 0.80  # [-] Main compressor isentropic efficiency
    default_par["eta_isen_pc"] = 0.80  # [-] Precompressor isentropic efficiency
    default_par["eta_isen_rc"] = 0.80  # [-] Recompressor Polytropic efficiency
