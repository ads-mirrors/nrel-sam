...
def get_g3p3_dict():
    g3p3_json_filename = r"C:\Users\tbrown2\OneDrive - NREL\sCO2-CSP 10302.41.01.40\Notes\G3P3\runs\TIT550_baseline_OPT\run_10_20250718_113615\raw data\sam_gen3_particle_for_tmb.json"
...
def run_post_process():
    ...
    # Get filenames
    base_folder = r"C:\Users\tbrown2\OneDrive - NREL\sCO2-CSP 10302.41.01.40\Notes\G3P3\runs\TIT550_baseline_OPT\run_10_20250718_113615\post"
    TIT550_filenames = sco2_filenames.get_all_files_from_folder(base_folder)
    
    #TIT550_filenames = sco2_filenames.get_filenames_TIT550_OPT(split=False)[0]
    ...
    if False:
        ...
        cost_post_process.modify_baseline(tes_vars, 0.5, "tes50", "tes", 
                                        g3p3_json_dict_arg = g3p3_json_dict, filenames=TIT550_filenames)
