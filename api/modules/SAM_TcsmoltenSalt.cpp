...
SAM_EXPORT int SAM_TcsmoltenSalt_execute(SAM_table data, int verbosity, SAM_error* err){
	return SAM_module_exec("tcsmolten_salt", data, verbosity, err);
}
...
SAM_EXPORT void SAM_TcsmoltenSalt_SystemControl_anc_elec_output_aset(SAM_table ptr, double* arr, int length, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_array(ptr, "anc_elec_output", arr, length);
	});
}
...
SAM_EXPORT void SAM_TcsmoltenSalt_SystemControl_is_control_target_elec_nset(SAM_table ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
		ssc_data_set_number(ptr, "is_control_target_elec", number);
	});
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_SystemControl_anc_elec_output_aget(SAM_table ptr, int* length, SAM_error *err){
	double* result = nullptr;
	translateExceptions(err, [&]{
	result = ssc_data_get_array(ptr, "anc_elec_output", length);
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "anc_elec_output");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_SystemControl_can_cycle_use_standby_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "can_cycle_use_standby", &result))
		make_access_error("SAM_TcsmoltenSalt", "can_cycle_use_standby");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_SystemControl_disp_csu_cost_rel_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "disp_csu_cost_rel", &result))
		make_access_error("SAM_TcsmoltenSalt", "disp_csu_cost_rel");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_SystemControl_disp_hsu_cost_rel_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "disp_hsu_cost_rel", &result))
		make_access_error("SAM_TcsmoltenSalt", "disp_hsu_cost_rel");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_SystemControl_disp_pen_ramping_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "disp_pen_ramping", &result))
		make_access_error("SAM_TcsmoltenSalt", "disp_pen_ramping");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_SystemControl_disp_rsu_cost_rel_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "disp_rsu_cost_rel", &result))
		make_access_error("SAM_TcsmoltenSalt", "disp_rsu_cost_rel");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_SystemControl_is_control_target_elec_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "is_control_target_elec", &result))
		make_access_error("SAM_TcsmoltenSalt", "is_control_target_elec");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_SystemControl_is_parallel_htr_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "is_parallel_htr", &result))
		make_access_error("SAM_TcsmoltenSalt", "is_parallel_htr");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_SystemControl_sim_type_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "sim_type", &result))
		make_access_error("SAM_TcsmoltenSalt", "sim_type");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_SystemControl_timestep_load_fractions_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "timestep_load_fractions");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_TowerAndReceiver_cav_rec_height_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "cav_rec_height", &result))
		make_access_error("SAM_TcsmoltenSalt", "cav_rec_height");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_TowerAndReceiver_cav_rec_passive_abs_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "cav_rec_passive_abs", &result))
		make_access_error("SAM_TcsmoltenSalt", "cav_rec_passive_abs");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_TowerAndReceiver_cav_rec_passive_eps_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "cav_rec_passive_eps", &result))
		make_access_error("SAM_TcsmoltenSalt", "cav_rec_passive_eps");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_TowerAndReceiver_cav_rec_span_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "cav_rec_span", &result))
		make_access_error("SAM_TcsmoltenSalt", "cav_rec_span");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_TowerAndReceiver_cav_rec_width_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "cav_rec_width", &result))
		make_access_error("SAM_TcsmoltenSalt", "cav_rec_width");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_TowerAndReceiver_n_cav_rec_panels_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "n_cav_rec_panels", &result))
		make_access_error("SAM_TcsmoltenSalt", "n_cav_rec_panels");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_ParallelHeater_f_q_dot_des_allowable_su_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "f_q_dot_des_allowable_su", &result))
		make_access_error("SAM_TcsmoltenSalt", "f_q_dot_des_allowable_su");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_ParallelHeater_f_q_dot_heater_min_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "f_q_dot_heater_min", &result))
		make_access_error("SAM_TcsmoltenSalt", "f_q_dot_heater_min");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_ParallelHeater_heater_efficiency_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "heater_efficiency", &result))
		make_access_error("SAM_TcsmoltenSalt", "heater_efficiency");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_ParallelHeater_heater_mult_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "heater_mult", &result))
		make_access_error("SAM_TcsmoltenSalt", "heater_mult");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_ParallelHeater_hrs_startup_at_max_rate_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "hrs_startup_at_max_rate", &result))
		make_access_error("SAM_TcsmoltenSalt", "hrs_startup_at_max_rate");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_SystemCosts_allow_heater_no_dispatch_opt_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "allow_heater_no_dispatch_opt", &result))
		make_access_error("SAM_TcsmoltenSalt", "allow_heater_no_dispatch_opt");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_SystemCosts_heater_spec_cost_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "heater_spec_cost", &result))
		make_access_error("SAM_TcsmoltenSalt", "heater_spec_cost");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_ThermalStorage_tes_init_hot_htf_percent_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "tes_init_hot_htf_percent", &result))
		make_access_error("SAM_TcsmoltenSalt", "tes_init_hot_htf_percent");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_FinancialSolutionMode_ppa_soln_mode_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "ppa_soln_mode", &result))
		make_access_error("SAM_TcsmoltenSalt", "ppa_soln_mode");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_ElectricityRates_en_electricity_rates_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "en_electricity_rates", &result))
		make_access_error("SAM_TcsmoltenSalt", "en_electricity_rates");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Revenue_ppa_price_input_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "ppa_price_input");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_AdjustmentFactors_adjust_constant_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "adjust_constant", &result))
		make_access_error("SAM_TcsmoltenSalt", "adjust_constant");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_AdjustmentFactors_adjust_en_periods_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "adjust_en_periods", &result))
		make_access_error("SAM_TcsmoltenSalt", "adjust_en_periods");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_AdjustmentFactors_adjust_periods_mget(SAM_table ptr, int* nrows, int* ncols, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "adjust_periods");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_AdjustmentFactors_adjust_timeindex_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "adjust_timeindex");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_AdjustmentFactors_sf_adjust_constant_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "sf_adjust_constant", &result))
		make_access_error("SAM_TcsmoltenSalt", "sf_adjust_constant");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_AdjustmentFactors_sf_adjust_en_periods_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "sf_adjust_en_periods", &result))
		make_access_error("SAM_TcsmoltenSalt", "sf_adjust_en_periods");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_AdjustmentFactors_sf_adjust_periods_mget(SAM_table ptr, int* nrows, int* ncols, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "sf_adjust_periods");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_AdjustmentFactors_sf_adjust_timeindex_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "sf_adjust_timeindex");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_HybridCosts_degradation_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "degradation");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_HybridCosts_land_area_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "land_area", &result))
		make_access_error("SAM_TcsmoltenSalt", "land_area");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_HybridCosts_om_capacity_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "om_capacity");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_HybridCosts_om_capacity_escal_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "om_capacity_escal", &result))
		make_access_error("SAM_TcsmoltenSalt", "om_capacity_escal");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_HybridCosts_om_fixed_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "om_fixed");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_HybridCosts_om_fixed_escal_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "om_fixed_escal", &result))
		make_access_error("SAM_TcsmoltenSalt", "om_fixed_escal");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_HybridCosts_om_land_lease_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "om_land_lease");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_HybridCosts_om_land_lease_escal_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "om_land_lease_escal", &result))
		make_access_error("SAM_TcsmoltenSalt", "om_land_lease_escal");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_HybridCosts_om_production_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "om_production");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_HybridCosts_om_production_escal_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "om_production_escal", &result))
		make_access_error("SAM_TcsmoltenSalt", "om_production_escal");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_A_rec_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "A_rec", &result))
		make_access_error("SAM_TcsmoltenSalt", "A_rec");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_D_rec_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "D_rec_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "D_rec_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_E_heater_su_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "E_heater_su_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "E_heater_su_des");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_L_tower_piping_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "L_tower_piping_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "L_tower_piping_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_N_hel_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "N_hel_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "N_hel_calc");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Outputs_P_cond_iter_err_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "P_cond_iter_err");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_Q_dot_HTF_ND_des_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "Q_dot_HTF_ND_des_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "Q_dot_HTF_ND_des_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_Q_tes_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "Q_tes_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "Q_tes_des");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_T_amb_high_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "T_amb_high_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "T_amb_high_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_T_amb_low_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "T_amb_low_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "T_amb_low_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_T_amb_ref_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "T_amb_ref_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "T_amb_ref_calc");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Outputs_T_htf_heater_in_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "T_htf_heater_in");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Outputs_T_htf_heater_out_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "T_htf_heater_out");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_T_htf_high_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "T_htf_high_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "T_htf_high_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_T_htf_low_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "T_htf_low_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "T_htf_low_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_T_htf_ref_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "T_htf_ref_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "T_htf_ref_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_V_tes_htf_avail_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "V_tes_htf_avail_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "V_tes_htf_avail_des");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_V_tes_htf_total_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "V_tes_htf_total_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "V_tes_htf_total_des");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_W_dot_bop_design_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "W_dot_bop_design", &result))
		make_access_error("SAM_TcsmoltenSalt", "W_dot_bop_design");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_W_dot_col_tracking_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "W_dot_col_tracking_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "W_dot_col_tracking_des");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_W_dot_cooling_ND_des_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "W_dot_cooling_ND_des_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "W_dot_cooling_ND_des_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_W_dot_cycle_cooling_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "W_dot_cycle_cooling_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "W_dot_cycle_cooling_des");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_W_dot_cycle_pump_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "W_dot_cycle_pump_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "W_dot_cycle_pump_des");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_W_dot_fixed_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "W_dot_fixed", &result))
		make_access_error("SAM_TcsmoltenSalt", "W_dot_fixed");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_W_dot_gross_ND_des_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "W_dot_gross_ND_des_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "W_dot_gross_ND_des_calc");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Outputs_W_dot_heater_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "W_dot_heater");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_W_dot_heater_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "W_dot_heater_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "W_dot_heater_des");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_W_dot_rec_pump_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "W_dot_rec_pump_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "W_dot_rec_pump_des");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_W_dot_rec_pump_rec_share_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "W_dot_rec_pump_rec_share_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "W_dot_rec_pump_rec_share_des");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_W_dot_rec_pump_tower_share_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "W_dot_rec_pump_tower_share_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "W_dot_rec_pump_tower_share_des");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Outputs_annual_energy_distribution_time_mget(SAM_table ptr, int* nrows, int* ncols, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "annual_energy_distribution_time");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_average_attenuation_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "average_attenuation", &result))
		make_access_error("SAM_TcsmoltenSalt", "average_attenuation");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_avg_suboptimal_rel_mip_gap_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "avg_suboptimal_rel_mip_gap", &result))
		make_access_error("SAM_TcsmoltenSalt", "avg_suboptimal_rel_mip_gap");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_capacity_factor_highest_1000_ppas_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "capacity_factor_highest_1000_ppas", &result))
		make_access_error("SAM_TcsmoltenSalt", "capacity_factor_highest_1000_ppas");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_capacity_factor_highest_2000_ppas_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "capacity_factor_highest_2000_ppas", &result))
		make_access_error("SAM_TcsmoltenSalt", "capacity_factor_highest_2000_ppas");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_cav_panel_width_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "cav_panel_width", &result))
		make_access_error("SAM_TcsmoltenSalt", "cav_panel_width");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_cav_radius_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "cav_radius", &result))
		make_access_error("SAM_TcsmoltenSalt", "cav_radius");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_cav_rec_area_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "cav_rec_area", &result))
		make_access_error("SAM_TcsmoltenSalt", "cav_rec_area");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_cav_rec_height_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "cav_rec_height_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "cav_rec_height_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_cav_rec_width_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "cav_rec_width_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "cav_rec_width_calc");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Outputs_cf_land_lease_expense_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "cf_land_lease_expense");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_cp_battery_nameplate_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "cp_battery_nameplate", &result))
		make_access_error("SAM_TcsmoltenSalt", "cp_battery_nameplate");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_cp_system_nameplate_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "cp_system_nameplate", &result))
		make_access_error("SAM_TcsmoltenSalt", "cp_system_nameplate");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Outputs_cycle_htf_pump_power_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "cycle_htf_pump_power");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_d_tank_tes_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "d_tank_tes", &result))
		make_access_error("SAM_TcsmoltenSalt", "d_tank_tes");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_dens_store_htf_at_T_ave_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "dens_store_htf_at_T_ave", &result))
		make_access_error("SAM_TcsmoltenSalt", "dens_store_htf_at_T_ave");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Outputs_disp_rel_mip_gap_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "disp_rel_mip_gap");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_disp_solve_state_ann_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "disp_solve_state_ann", &result))
		make_access_error("SAM_TcsmoltenSalt", "disp_solve_state_ann");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Outputs_disp_subopt_flag_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "disp_subopt_flag");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_eta_rec_thermal_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "eta_rec_thermal_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "eta_rec_thermal_des");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_ext_rec_area_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "ext_rec_area", &result))
		make_access_error("SAM_TcsmoltenSalt", "ext_rec_area");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_ext_rec_aspect_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "ext_rec_aspect", &result))
		make_access_error("SAM_TcsmoltenSalt", "ext_rec_aspect");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_h_rec_input_to_cost_model_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "h_rec_input_to_cost_model", &result))
		make_access_error("SAM_TcsmoltenSalt", "h_rec_input_to_cost_model");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_h_tower_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "h_tower_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "h_tower_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_heater_cost_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "heater_cost", &result))
		make_access_error("SAM_TcsmoltenSalt", "heater_cost");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Outputs_helio_positions_calc_mget(SAM_table ptr, int* nrows, int* ncols, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "helio_positions_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_heliostat_area_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "heliostat_area", &result))
		make_access_error("SAM_TcsmoltenSalt", "heliostat_area");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Outputs_is_PAR_HTR_allowed_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "is_PAR_HTR_allowed");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_land_area_base_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "land_area_base_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "land_area_base_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_land_max_abs_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "land_max_abs", &result))
		make_access_error("SAM_TcsmoltenSalt", "land_max_abs");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_land_min_abs_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "land_min_abs", &result))
		make_access_error("SAM_TcsmoltenSalt", "land_min_abs");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_m_dot_htf_ND_high_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "m_dot_htf_ND_high_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "m_dot_htf_ND_high_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_m_dot_htf_ND_low_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "m_dot_htf_ND_low_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "m_dot_htf_ND_low_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_m_dot_htf_ND_ref_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "m_dot_htf_ND_ref_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "m_dot_htf_ND_ref_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_m_dot_htf_cycle_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "m_dot_htf_cycle_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "m_dot_htf_cycle_des");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Outputs_m_dot_htf_heater_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "m_dot_htf_heater");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_m_dot_htf_rec_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "m_dot_htf_rec_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "m_dot_htf_rec_des");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_m_dot_htf_rec_max_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "m_dot_htf_rec_max", &result))
		make_access_error("SAM_TcsmoltenSalt", "m_dot_htf_rec_max");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_m_dot_water_ND_des_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "m_dot_water_ND_des_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "m_dot_water_ND_des_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_n_T_amb_pars_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "n_T_amb_pars_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "n_T_amb_pars_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_n_T_htf_pars_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "n_T_htf_pars_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "n_T_htf_pars_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_n_m_dot_pars_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "n_m_dot_pars_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "n_m_dot_pars_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_nameplate_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "nameplate", &result))
		make_access_error("SAM_TcsmoltenSalt", "nameplate");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_q_dot_cycle_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "q_dot_cycle_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "q_dot_cycle_des");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Outputs_q_dot_elec_to_PAR_HTR_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "q_dot_elec_to_PAR_HTR");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_q_dot_heater_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "q_dot_heater_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "q_dot_heater_des");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Outputs_q_dot_heater_startup_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "q_dot_heater_startup");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Outputs_q_dot_heater_to_htf_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "q_dot_heater_to_htf");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_q_dot_loss_tes_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "q_dot_loss_tes_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "q_dot_loss_tes_des");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_q_dot_piping_loss_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "q_dot_piping_loss_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "q_dot_piping_loss_des");
	});
	return result;
}

SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_q_dot_rec_abs_from_sf_est_des_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "q_dot_rec_abs_from_sf_est_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "q_dot_rec_abs_from_sf_est_des");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_q_dot_rec_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "q_dot_rec_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "q_dot_rec_des");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Outputs_rec_defocus_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "rec_defocus");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_rec_height_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "rec_height_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "rec_height_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_rec_sm_from_sf_est_des_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "rec_sm_from_sf_est_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "rec_sm_from_sf_est_des");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_refl_image_error_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "refl_image_error", &result))
		make_access_error("SAM_TcsmoltenSalt", "refl_image_error");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_sales_energy_capacity_factor_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "sales_energy_capacity_factor", &result))
		make_access_error("SAM_TcsmoltenSalt", "sales_energy_capacity_factor");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_sim_cpu_run_time_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "sim_cpu_run_time", &result))
		make_access_error("SAM_TcsmoltenSalt", "sim_cpu_run_time");
	});
	return result;
}
...
SAM_EXPORT double* SAM_TcsmoltenSalt_Outputs_tes_htf_pump_power_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_TcsmoltenSalt", "tes_htf_pump_power");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_total_land_area_before_rad_cooling_calc_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "total_land_area_before_rad_cooling_calc", &result))
		make_access_error("SAM_TcsmoltenSalt", "total_land_area_before_rad_cooling_calc");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_tshours_heater_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "tshours_heater", &result))
		make_access_error("SAM_TcsmoltenSalt", "tshours_heater");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_tshours_rec_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "tshours_rec", &result))
		make_access_error("SAM_TcsmoltenSalt", "tshours_rec");
	});
	return result;
}
...
SAM_EXPORT double SAM_TcsmoltenSalt_Outputs_vel_rec_htf_des_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "vel_rec_htf_des", &result))
		make_access_error("SAM_TcsmoltenSalt", "vel_rec_htf_des");
	});
	return result;
}
