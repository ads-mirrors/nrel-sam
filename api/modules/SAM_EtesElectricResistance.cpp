...
SAM_EXPORT void SAM_EtesElectricResistance_TimeOfDeliveryFactors_start_day_of_year_nset(SAM_table ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT double* SAM_EtesElectricResistance_TimeOfDeliveryFactors_dispatch_tod_factors_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_EtesElectricResistance", "dispatch_tod_factors");
	});
	return result;
}
...
SAM_EXPORT double SAM_EtesElectricResistance_TimeOfDeliveryFactors_start_day_of_year_nget(SAM_table ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
	if (!ssc_data_get_number(ptr, "start_day_of_year", &result))
		make_access_error("SAM_EtesElectricResistance", "start_day_of_year");
	});
	return result;
}
...
SAM_EXPORT double SAM_EtesElectricResistance_AdjustmentFactors_adjust_constant_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "adjust_constant", &result))
		make_access_error("SAM_EtesElectricResistance", "adjust_constant");
	});
	return result;
}
...
SAM_EXPORT double SAM_EtesElectricResistance_AdjustmentFactors_adjust_en_periods_nget(SAM_table ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "adjust_en_periods", &result))
		make_access_error("SAM_EtesElectricResistance", "adjust_en_periods");
	});
	return result;
}
...
SAM_EXPORT double* SAM_EtesElectricResistance_AdjustmentFactors_adjust_periods_mget(SAM_table ptr, int* nrows, int* ncols, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_EtesElectricResistance", "adjust_periods");
	});
	return result;
}
...
SAM_EXPORT double* SAM_EtesElectricResistance_AdjustmentFactors_adjust_timeindex_aget(SAM_table ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_EtesElectricResistance", "adjust_timeindex");
	});
	return result;
}
